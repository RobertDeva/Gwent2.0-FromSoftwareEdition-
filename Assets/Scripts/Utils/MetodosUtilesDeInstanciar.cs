...
{
    public static void InstanciarCarta(GameObject card, IPlayable carta, GwentPlayer player)
    {
    ...
    public static void InstanciarSeñuelo(GameObject card, IPlayable carta, GwentPlayer player)
    {
        Instantiate(card, GameBoard.TransformsZones[carta.Origin].transform, false);
